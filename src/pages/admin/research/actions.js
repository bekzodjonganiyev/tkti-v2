  ...
  export class ResearchParentActions {
    getData() {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.get("ilmiytad/all");
        if (res.status === 200) {
          dispatch({
    ...
    getDataById(id) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.get(`ilmiytad/${id}`);
        if (res.status === 200) {
          dispatch({
    ...
    postData(body) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.add("ilmiytad/add", body);
        if (res.status === 200) {
          dispatch({
    ...
    updateData(id, body) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.update(`ilmiytad/${id}`, body);
        if (res.status === 200) {
          dispatch({
    ...
    deleteData(id) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.delete(`ilmiytad/${id}`);
        if (res.status === 200) {
          dispatch({
  ...
  export class ResearchChildActions {
    getData() {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.get("ilmiytad_data_child/all");
        if (res.status === 200) {
          dispatch({
    ...
    getDataById(id) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.get(`ilmiytad_data_child/${id}`);
        if (res.status === 200) {
          dispatch({
    ...
    postData(body) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.add("ilmiytad_data_child/add", body, true);
        if (res.status === 200) {
          dispatch({
    ...
    updateData(id, body) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.update(`ilmiytad_data_child/${id}`, body, true);
        if (res.status === 200) {
          dispatch({
    ...
    deleteData(id) {
      return async (dispatch) => {
        ...
        const res = await apiClientWithFetch.delete(`ilmiytad_data_child/${id}`);
        if (res.status === 200) {
          dispatch({
