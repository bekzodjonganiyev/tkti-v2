...
import madhiya from "../../assets/images/madhiya.png";
import bayroq from "../../assets/images/bayroq.jpg";
        ...
        <div className="page_main ">
          <div className="clearfix" id="content">
            <div className="symbols">
             ...
             <div>
                <img className="symbol" width={1600} height={1000} alt="gerb" src={Gerb} />
                <br />
                <h4 className="symbol">{hero[lang]?.gerb?.first}</h4>
              </div>
             ...
             <div>
                <img className="symbol" width={500} height={1000}  alt="gerb" src={bayroq} />
                <br />
                <h4 className="symbol">
              ...
              <div className="row">
                ...
                <div className="col-lg-6 col-md-6 my-16">
