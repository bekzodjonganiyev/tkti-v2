    ...
    <div className="wrapped mb-5">
      <div className="bizningmanzilwrapper">
        <div className="bizningmanziltext">
          <h3>{BizBilanAloqaLang[lang].text1}</h3>
          <br />
          <h5>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-12 col-sm-12">
              ...
              <p>
                <a
                  href="https://www.google.com/maps/place/41.32210039419172, 69.24663152831377"
                  target="_blank"
                >
                ...
                (+998-71) 244-79-17 <br />
                <span>{BizBilanAloqaLang[lang].bizningManzil.fourth}</span>{" "}
                <a href="mailto:txti_rektor@edu.uz">txti_rektor@edu.uz</a>,{" "}
          ...
          <div className="row">
            ...
            <div className="col-lg-6 col-md-12 col-sm-12">
              <h4>{BizBilanAloqaLang[lang].faculty_names.fifth}</h4>
              <p>
                {BizBilanAloqaLang[lang].bizningManzil.eightth}
                <br /> Tel. (998-71) 254-58-87
              </p>
            </div>
            <hr />
          </div>
